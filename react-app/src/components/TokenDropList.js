...
export default function TokenDropList({ tokens,toggleDropDown, updateSelectedToken }) {
  return (
    <div className="flex justify-start flex-col m-8 bg-slight-black text-grey-font rounded-lg p-4 w-1/2">
      {tokens && (
        <div className="flex flex-col">
          <div className="flex flex-row">
            <img src={leftArrow} alt="v" className="mr-4" onClick={ ()=> {toggleDropDown(false)}}/>
